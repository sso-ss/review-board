...
### 5단계 — Pull Request 보내기

Push가 완료되면 GitHub 저장소 페이지로 가세요.

**화면에 이런 노란색 배너가 보입니다:**

```
┌──────────────────────────────────────────────────────────┐
│  🟡 review/soeun had recent pushes — Compare & pull request  │
└──────────────────────────────────────────────────────────┘
```
→ **"Compare & pull request"** 초록 버튼 클릭!
...
│  Open a pull request                                     │
│                                                          │
│  제목: Add review: soeun           (자동으로 채워져 있음)  │
│                                                          │
│  설명: (비워둬도 OK)                                      │
│                                                          │
│              [ Create pull request ]  ← 이 버튼 클릭!    │
└──────────────────────────────────────────────────────────┘
```
→ **"Create pull request"** 초록 버튼 클릭! 끝!

> 🙋 **여기까지가 여러분이 할 일입니다!**  
> 오너(관리자)가 확인 후 **"Merge"** 버튼을 눌러 main에 합쳐줍니다.

🎉 이게 바로 **Branch → PR → Merge** 워크플로우입니다.
